        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                for (int m = 0; m < 4; m++)
                {
                    for (int j = 0; j < 4; j++)
                    {
                        Console.Write(step2[m, j].ToString("X2") + " ");
                    }
                    Console.WriteLine();
                }
                ...
                for (int m = 0; m < 4; m++)
                {
                    for (int j = 0; j < 4; j++)
                    {
                        Console.Write(step3[m, j].ToString("X2") + " ");
                    }
                    Console.WriteLine();
                }
                ...
                Console.WriteLine("After Mixcolumn: \n");

                for (int m = 0; m < 4; m++)
                {
                    for (int j = 0; j < 4; j++)
                    {
                        Console.Write(step4[m, j].ToString("X2") + " ");
                    }
                    Console.WriteLine();
                }
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    Console.Write(convertArray_key[i, j].ToString("X2") + " ");
                }
                Console.WriteLine();
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    Console.Write(last[i, j].ToString("X2") + " ");
                }
                Console.WriteLine();
            }
